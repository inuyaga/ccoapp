            ...
            children: [            
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text("Total Compra:", style: getStylo(),),
                    Text(r'$'+"${oCcy.format(widget.totalpedido)}", style: getStylo(),),
                  ],
                ),
              ),
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("Costo de Envio:", style: getStylo(),),
                    Text(r'$'+"${oCcy.format(costoEnvio)}", style: getStylo(),),
                  ],
                ),
              ),
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("Total pedido:", style: getStylo(),),
                    Text(r'$'+"${oCcy.format(widget.totalpedido + costoEnvio)}", style: getStylo(),),
                  ],
                ),
              ),
             ...
             loading == false ? FlatButton(
                        ...
                        mostraAlerta(
                            ...
                            cuerpo: ListBody(
                              children: [
                                ...
                                Text("Enviar captura al Email compracompucopias@ejemplo.com"),
                              ],
                            )
                          );
              ...
              SizedBox(
                height: 100,
                width: 100,
                child: LoadingIndicator(indicatorType: Indicator.values[12], color: Colors.amber),
              )
            ],
          ),
        ),
